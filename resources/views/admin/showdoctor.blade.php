        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <table>
                ...
                <tr align="center" style="background-color:skyblue">
                    ...
                    <td style="padding:10px">{{$doctor->days}}</td>
                    <td style="padding:10px">{{$doctor->availability}}</td>
                    <td style="padding:10px">{{$doctor->room}}</td>
                    <td style="padding:10px"><img height="100" width= "100" src="doctorimage/{{$doctor->image}}"></td>

                    <td>
                        <a href="{{url('update',$doctor->id)}}" class="btn btn-success">Update</a>
                    </td>
                    <td>
                        <a href="{{url('delete',$doctor->id)}} " class="btn btn-danger" onclick="return confirm ('are you sure to delete it')">Delete</a>
                    </td>
                </tr>
                @endforeach
            </table>
