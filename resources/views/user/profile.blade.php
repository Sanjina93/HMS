...
<body>
    ...
    <div class="page-section">
        ...
        <div class="container">
            <h1 class="text-center mb-5 wow fadeInUp">Our Doctor</h1>

            <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">

                    <div class="item">
                        <div class="header">
                            <img src="{{ url('doctorimage/' . $doctor->image) }}" alt="" style="max-height:300px; width:auto;">


                        </div>
                        <div style="margin: 20px; display: flex; flex-direction: column;">
                            <div style="display: flex;">
                                <p style="margin-right: 10px; font-size:x-large;">Dr.</p>

                                <p class="mb-0" style="font-size:x-large;">{{ $doctor->name }}</p>

                            </div>
                            <span class="text-lg" style="display: inline;">Speciality:
                                {{ $doctor->speciality }}</span>
                        </div>
                    </div>
                        <div>
                            <table align="center" style=" text:center; padding-bottom:70px;">
                                <tr style="background-color:black;">
                                    <th style="padding:10px; font-size:20px; color:white">Days</th>
                                    <th style="padding:10px; font-size:20px; color:white">Time Availability</th>
                                </tr>
                                <tr style="background-color:black;" align="center">
                                    <td style="padding:10px;  color:white;">{{$doctor->days}}</td>
                                    <td style="padding:10px;  color:white;">{{$doctor->availability}}</td>
                                </tr>
                            </table>
                        </div>
            </div>
